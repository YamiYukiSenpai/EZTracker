	...
	<body class="loginBody" id="runningMan" background="background2.jpg">	
		...
		<div  id="loginWrapper">
			<form name="login" action="login.php" method="POST">
				...
				<div id="failinside">
					<br/><label for="uname" id="failPlace"><strong>Incorrect information. Please try again.</strong></label><br/><br/>

				</div>
				<div id="submitBtn">
					<input type="submit" value="Retry" class="button"><span></span></input>	
				</div>		
			</form>		
		</div>			
	</body>
